========================================================================
    活动模板库 : MyPropertySheet 项目概述
========================================================================

应用程序向导已为您创建了此 MyPropertySheet 项目，作为编写动态链接库 (DLL) 
的起点。

本文件概要介绍组成项目的每个文件的内容。

MyPropertySheet.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，
    其中包含生成该文件的 Visual C++ 的版本信息，
    以及有关使用应用程序向导选择的平台、配置和项目功能的信息。

MyPropertySheet.vcxproj.filters
...
MyPropertySheet.idl
    ...
    此文件将由 MIDL 编译器处理以生成：
        C++ 接口定义和 GUID 声明		(MyPropertySheet.h)
        GUID 定义			(MyPropertySheet_i.c)
        类型库				(MyPropertySheet.tlb)
        封送处理代码			(MyPropertySheet_p.c 和 
                                           dlldata.c）

MyPropertySheet.h
    此文件包含 MyPropertySheet.idl 中定义的项目的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 MyPropertySheet.pch 的预编译头 (PCH) 文件和
